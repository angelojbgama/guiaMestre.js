...
document.addEventListener('DOMContentLoaded', () => { // Aguarda o carregamento completo do DOM
    ...
    const steps = [
        ...
        },
        {
            ...
            imagemOrder: 'before',  // Ordem da imagem: 'before' ou 'after'
            imagemCentered: false    // Alinhamento da imagem: true (centralizada) ou false (não centralizada)
        },
        {
            helper: 'email', // Novo passo com diferentes configurações de imagem
            text: 'Insira seu e-mail para receber atualizações.',
            position: 'left',
            imagem: 'https://c.tenor.com/example.gif', // Substitua com uma URL válida
            imagemWidth: '15rem',
            imagemHeight: 'auto',
            imagemOrder: 'after',
            imagemCentered: false
        }
    ];
